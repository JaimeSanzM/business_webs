...
- **100% HTML/CSS/JS vanilla** — un único archivo `index.html`, sin frameworks ni dependencias de build
...
Abre `index.html` directamente en el navegador. No necesita servidor local.
